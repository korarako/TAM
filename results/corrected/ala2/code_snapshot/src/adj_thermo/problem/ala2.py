...
def make_problem(
    ...
    device = openmm_device or os.environ.get("ADTM_ALA2_OPENMM_DEVICE", "cpu")
    system_name = openmm_system or os.environ.get("ADTM_ALA2_OPENMM_SYSTEM", "amber99sbildn_obc1_xml")
    if openmm_grad_clip is None:
        env_clip = os.environ.get("ADTM_ALA2_OPENMM_GRAD_CLIP")
